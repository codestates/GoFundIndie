...
--Board
INSERT INTO `board` (id, is_approve, title, producer, distributor, poster_img, view_link, info_country, info_created_at, info_time, info_limit, info_story, info_subtitle) VALUES (1,false,"테스트용 보드 입니다","제작사","배급사",null,null,"한국",now(),120,1,"테스트를 하기위한 더미데이터",true);
...
INSERT INTO `board` (id, is_approve, title, producer, distributor, poster_img, view_link, info_country, info_created_at, info_time, info_limit, info_story, info_subtitle) VALUES (3,false,"CORS 가 밉다","Soul of Asia",null,"https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Empty_Star.svg/1200px-Empty_Star.svg.png","https://www.naver.com/","한국",now(),80,1,"<p>CORS가 밉다</p><p></p><p>CORS가 너무 밉다</p><p>CORS가 CORS가 CORS가</p>",false);
INSERT INTO `board` (id, is_approve, title, producer, distributor, poster_img, view_link, info_country, info_created_at, info_time, info_limit, info_story, info_subtitle) VALUES (4,false,"이터널스","마블","디즈니","https://upload.wikimedia.org/wikipedia/commons/thumb/6/63/Star%2A.svg/600px-Star%2A.svg.png",null,"미국",now(),120,1,"<p>마블 스튜디오의 <이터널스>는 수 천년에 걸쳐 그 모습을 드러내지 않고 살아온 불멸의 히어로들이</p>",true);
INSERT INTO `board` (id, is_approve, title, producer, distributor, poster_img, view_link, info_country, info_created_at, info_time, info_limit, info_story, info_subtitle) VALUES (5,false,"TEST BOARD","producer","distributor",null,null,"태국",now(),120,1,"<p>DUMMY DATA</p>",true);
