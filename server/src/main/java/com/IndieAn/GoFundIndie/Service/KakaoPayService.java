...
public class KakaoPayService {
    ...
    public ResponseEntity<?> KakaoPayReadyRequest(int amount, Map<String, String> requestHeader) {
        body = new HashMap<>();
    ...
    public ResponseEntity<?> KakaoPayApproval(KakaoPayApproveInputDTO kakaoPayApproveInputDTO, Map<String, String> requestHeader) {
        ...
        // 토큰이 유효하다면 작성 기능을 수행한다.
        if(checkToken.get("email") != null) {
            body = kakaoPayInfo(kakaoPayApproveInputDTO, (String)checkToken.get("email"));
